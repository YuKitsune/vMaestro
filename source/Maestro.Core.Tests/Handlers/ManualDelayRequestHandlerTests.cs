...
public class ManualDelayRequestHandlerTests(ClockFixture clockFixture)
{
    ...
    public async Task WhenFlightHasDelayAboveMaximum_FlightIsRepositionedToReduceDelay()
    {
        ...
        (flight3.RequiredEnrouteDelay + flight3.RequiredTerminalDelay).ShouldBeLessThanOrEqualTo(TimeSpan.FromMinutes(3));
    ...
    public async Task WhenAssigningZeroDelay_DelayIsNoMoreThanRunwayAcceptanceRate()
    {
        ...
        (flight3.RequiredEnrouteDelay + flight3.RequiredTerminalDelay).ShouldBeLessThan(AcceptanceRate);
