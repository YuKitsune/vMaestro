...
public class ResumeSequencingRequestHandlerTests(ClockFixture clockFixture)
{
    ...
    public async Task FlightIsInsertedByLandingEstimate()
    {
        ...
        sequence.Flights[0].Callsign.ShouldBe("QFA1", "First flight should be QFA1 (Landing=+15)");
        sequence.Flights[1].Callsign.ShouldBe("QFA3", "Second flight should be QFA3 (Landing=+20)");
        sequence.Flights[2].Callsign.ShouldBe("QFA2", "Third flight should be QFA2 (Landing=+25)");
    }
