...
public class RecomputeRequestHandlerTests(ClockFixture clockFixture)
{
    ...
    public async Task TheFlightIsMovedBasedOnItsLandingEstimate()
    {
        ...
        session.FlightDataRecords["QFA2"] = new FlightDataRecord(
            ...
            flight2.OriginIdentifier, flight2.DestinationIdentifier, null, TimeSpan.FromHours(1), FlightPlanState.Active, null,
    ...
    public async Task TheSequenceIsRecalculated()
    {
        ...
        var flight1 = new FlightBuilder("QFA1")
            ...
            .WithTrajectory(new TerminalTrajectory(_defaultTtg))
            .WithRunway("34L")
            .WithState(State.Stable)
            .Build();
        ...
        session.FlightDataRecords["QFA3"] = new FlightDataRecord(
            ...
            flight3.OriginIdentifier, flight3.DestinationIdentifier, null, TimeSpan.FromHours(1), FlightPlanState.Active, null,
    ...
    public async Task FeederFixIsReCalculated()
    {
        ...
        session.FlightDataRecords["QFA1"] = new FlightDataRecord(
            ...
            flight.OriginIdentifier, flight.DestinationIdentifier, null, TimeSpan.FromHours(1), FlightPlanState.Active, null,
