...
public class FlightViewModel
{
    public FlightViewModel()
    {
        ...
        InitialFeederFixEstimate = DateTimeOffset.UtcNow.AddMinutes(1);
        FeederFixEstimate = DateTimeOffset.UtcNow.AddMinutes(2);
        FeederFixTime = DateTimeOffset.UtcNow.AddMinutes(3);
        AssignedRunway = "34L";
        NumberToLandOnRunway = 5;
        InitialLandingEstimate = DateTimeOffset.UtcNow.AddMinutes(5);
        LandingEstimate = DateTimeOffset.UtcNow.AddMinutes(6);
        LandingTime = DateTimeOffset.UtcNow.AddMinutes(7);
