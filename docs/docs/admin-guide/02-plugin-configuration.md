...
Airports:
  - Identifier: YSSY
    ...
    MinimumAutoActivationFlightTimeMinutes: 30
...
| `MinimumAutoActivationFlightTimeMinutes` | integer | 30 | Flights with an estimated flight time shorter than this value will not be auto-activated |
