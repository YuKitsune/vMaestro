...
- [ ] When inserting a departure, landing estimate is derived from take-off time and EET
- [ ] When inserting a departure, it is inserted based on it's landing estimate
...
- [ ] When inserting a flight, at a specific time, the landing estimate is set to the provided time
- [ ] When inserting a flight, at a specific time, the runway is set based on the runway mode at the provided time
- [ ] When inserting a flight, at a specific time, the flight is inserted based on it's landing estimate

- [ ] When inserting a flight, behind another one, the runway is set to the reference flights runway
- [ ] When inserting a flight, behind another one, the landing time is set to the reference flights landing time plus the runways acceptance rate
- [ ] When inserting a flight, behind another one, the flight is sequenced behind the reference flight

- [ ] When inserting a flight, ahead of another one, the runway is set to the reference flights runway
...
- [ ] When inserting an overshoot, at a specific time, the landing estiamte is set to the provided time
- [ ] When inserting an overshoot, at a specific time, the runway is set based on the runway mode at the provided time
- [ ] when inserting an overshoot, at a specific time, the flight is moved based on it's landing estimate

- [ ] When inserting an overshoot, behind another one, the runway is set to the reference flights runway
- [ ] When inserting an overshoot, behind another one, the landing time is set to the reference flights landing time plus the runways acceptance rate
- [ ] When inserting an overshoot, behind another one, the flight is moved behind the reference flight

- [ ] When inserting an overshoot, ahead of another one, the runway is set to the reference flights runway
...
- [ ] When inserting a pending flight, at a specific time, the landing estiamte is set to the provided time
- [ ] When inserting a pending flight, at a specific time, the runway is set based on the runway mode at the provided time
- [ ] when inserting a pending flight, at a specific time, the flight is inserted based on it's landing estimate
- [ ] when inserting a pending flight, at a specific time, the flight is removed from the pending list

- [ ] When inserting a pending flight, behind another one, the runway is set to the reference flights runway
- [ ] When inserting a pending flight, behind another one, the landing time is set to the reference flights landing time plus the runways acceptance rate
- [ ] When inserting a pending flight, behind another one, the flight is inserted behind the reference flight
- [ ] When inserting a pending flight, behind another one, the flight is removed from the pending list

- [ ] When inserting a pending flight, ahead of another one, the runway is set to the reference flights runway
- [ ] When inserting a pending flight, ahead of another one, the landing time is set to the reference flights landing time
- [ ] When inserting a pending flight, ahead of another one, the flight is inserted ahead of the reference flight
- [ ] When inserting a pending flight, ahead another one, the flight is removed from the pending list

- [ ] When inserting a pending flight, it is stable

- [ ] When inserting a pending flight, and we are in slave mode, the request is relayed to the master

## Make Stable

- [ ] When made stable, unstable flights become stable
- [ ] When made stable, other flights are ignored

- [ ] When made stable, and we are in slave mode, the request is relayed to the master
