...
- [ ] Trim down the Sequence aggregate
    ...
    - [X] Add Momento for Session, and synchronise it with the server
    - [X] Introduce simpler sequence interaction methods
    ...
    - [X] Extract logic from Sequence methods into the MediatR handlers that use them
